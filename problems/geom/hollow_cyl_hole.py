...
cubit.cmd('export genesis "~/projects/anteater/problems/geom/hollow_cyl_hole_r0.e" overwrite')

#for i in xrange(0,2):
#    cubit.cmd('refine volume all numsplit 1 bias 1 depth 1 smooth')
#    cubit.cmd('export genesis "~/projects/anteater/problems/geom/hollow_cyl_hole_r' + str(i + 1) + '.e" overwrite')
